...
func (vcdClient *VCDClient) CreateSegmentProfileTemplate(segmentProfileConfig *types.NsxtSegmentProfileTemplate) (*NsxtSegmentProfileTemplate, error) {
	...
	return genericCreateEntity(&vcdClient.Client, outerType, c, segmentProfileConfig)
}
...
func (vcdClient *VCDClient) GetAllSegmentProfileTemplates(queryFilter url.Values) ([]*NsxtSegmentProfileTemplate, error) {
	...
	outerType := NsxtSegmentProfileTemplate{VCDClient: vcdClient}
	return genericGetAllEntities[NsxtSegmentProfileTemplate, types.NsxtSegmentProfileTemplate](&vcdClient.Client, outerType, c)
}
...
func (vcdClient *VCDClient) GetSegmentProfileTemplateById(id string) (*NsxtSegmentProfileTemplate, error) {
	...
	outerType := NsxtSegmentProfileTemplate{VCDClient: vcdClient}
	return genericGetSingleEntity[NsxtSegmentProfileTemplate, types.NsxtSegmentProfileTemplate](&vcdClient.Client, outerType, c)
}
...
func (spt *NsxtSegmentProfileTemplate) Update(nsxtSegmentProfileTemplateConfig *types.NsxtSegmentProfileTemplate) (*NsxtSegmentProfileTemplate, error) {
	...
	if nsxtSegmentProfileTemplateConfig.ID == "" { // TODO - `genericCrudConfig` or `genericGetSingleBareEntity` could do such validation?
		return nil, fmt.Errorf("cannot NSX-T Segment Profile Template ID")
	}
	...
	return genericUpdateEntity(&spt.VCDClient.Client, outerType, c, nsxtSegmentProfileTemplateConfig)
}
