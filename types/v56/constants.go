...
const (
	// FirewallGroupTypeSecurityGroup can be used in types.NsxtFirewallGroup for type to create
	// Security Group
	FirewallGroupTypeSecurityGroup = "SECURITY_GROUP"
	// FirewallGroupTypeIpSet can be used in types.NsxtFirewallGroup for type to create IP Set
